...
class RecipeManager {
        ...
        (recipe) => `
            <div class="recipe-card" data-id="${recipe.id}">
                ...
                <div class="recipe-content">
                    ...
                    <!-- times row: Prep / Cook / Total with clock icon -->
                    <div class="recipe-meta">
                        <span class="meta-item">${this.getTimeIcon()} Prep: ${
          recipe.prepTime
        } min</span>
                        <span class="meta-item">${this.getTimeIcon()} Cook: ${
          recipe.cookTime
        } min</span>
                        <span class="meta-item">${this.getTimeIcon()} Total: ${
          recipe.prepTime + recipe.cookTime
        } min</span>
                    </div>

                    <!-- actions row: view/edit left, difficulty pill bottom-right -->
                    <div class="recipe-actions">
                        <div class="action-buttons">
                            <button class="btn-primary view-recipe">View</button>
                            <button class="btn-secondary edit-recipe">Edit</button>
                        </div>
                        <span class="card-difficulty-pill difficulty-${
                          recipe.difficulty
                        }">${
            ...
            <div class="recipe-detail-header">
                ...
                <div class="recipe-detail-info">
                    ...
                    <div class="recipe-detail-meta">
                        <div class="meta-item">
                            <span class="meta-label">${this.getTimeIcon()} Prep Time</span>
                            <span class="meta-value">${
                              recipe.prepTime
                            } minutes</span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">${this.getTimeIcon()} Cook Time</span>
                            <span class="meta-value">${
                              recipe.cookTime
                            } minutes</span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">${this.getTimeIcon()} Total Time</span>
                            <span class="meta-value">${
                              recipe.prepTime + recipe.cookTime
                            } minutes</span>
                        </div>
                        <div class="meta-item">
                            ...
                            <span class="meta-value recipe-difficulty difficulty-${
                              recipe.difficulty
                            }">${
      recipe.difficulty.charAt(0).toUpperCase() + recipe.difficulty.slice(1)
    }</span>
  ...
  setupEventListeners() {
    ...
    const debouncedSearch = this.debounce(() => this.searchRecipes(), 180)
    document
      .getElementById('search-input')
      .addEventListener('input', debouncedSearch)

    // keep existing Enter behaviour (optional)
  ...
  // small clock SVG helper used in meta
  getTimeIcon() {
