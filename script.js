...
class RecipeManager {
    ...
    initializeSampleRecipes() {
        ...
        const pizzaRecipe = {
            ...
            cookTime: 10,
            difficulty: "medium",
            imageUrl: "https://wallpaperbat.com/img/97392-food-pizza-cheese-hd-wallpaper-desktop-and-mobile-image-photo.jpg"
        };
    ...
    renderRecipes(filteredRecipes = null) {
        ...
        recipesGrid.innerHTML = recipesToRender.map(recipe => `
            <div class="recipe-card" data-id="${recipe.id}">
                <div class="recipe-image" style="background-image: url('${recipe.imageUrl || 'https://via.placeholder.com/300x200?text=No+Image'}')"></div>
    ...
    showRecipeDetail(recipeId) {
        ...
        detailContent.innerHTML = `
            <div class="recipe-detail-header">
                <div class="recipe-detail-image" style="background-image: url('${recipe.imageUrl || 'https://via.placeholder.com/300x200?text=No+Image'}')"></div>
                <div class="recipe-detail-info">
                    ...
                    <div class="recipe-detail-meta">
                        ...
                        <div class="meta-item">
                            ...
                            <span class="meta-value recipe-difficulty difficulty-${recipe.difficulty}">${recipe.difficulty.charAt(0).toUpperCase() + recipe.difficulty.slice(1)}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        document.getElementById('edit-recipe').onclick = () => this.editRecipe(recipeId);
        document.getElementById('delete-recipe').onclick = () => this.confirmDelete(recipeId);
    ...
    validateForm() {
        ...
        if (!prepTime || prepTime < 1) {
            document.getElementById('prep-time-error').textContent = 'Valid prep time is required';
        ...
        if (!cookTime || cookTime < 1) {
            document.getElementById('cook-time-error').textContent = 'Valid cook time is required';
        ...
        if (!difficulty) {
            document.getElementById('difficulty-error').textContent = 'Difficulty is required';
        ...
        if (steps.length === 0) {
            document.getElementById('steps-error').textContent = 'At least one step is required';
